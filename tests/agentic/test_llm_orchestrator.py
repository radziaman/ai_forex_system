...
from agentic.core.llm_brain import SignalHeuristics, LLMTradePlan, LLMDecision
from agentic.core.reflection_loop import ReflectionLoop


class TestSignalHeuristics:
    def test_heuristic_approves_high_confidence(self):
        brain = SignalHeuristics()
        plan = brain.evaluate_signal(
            symbol="EURUSD",
            direction="BUY",
            confidence=0.85,
            regime="trending",
